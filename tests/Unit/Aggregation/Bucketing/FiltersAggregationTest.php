...
use Packback\ElasticsearchDSL\Aggregation\Bucketing\FiltersAggregation;
...
class FiltersAggregationTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $aggregation = new FiltersAggregation('test_agg');
        $filter = $this->getMockBuilder('Packback\ElasticsearchDSL\BuilderInterface')
    ...
    public function testConstructorFilter()
    {
        ...
        $builderInterface1 = $this->getMockForAbstractClass('Packback\ElasticsearchDSL\BuilderInterface');
        /** @var BuilderInterface|\PHPUnit_Framework_MockObject_MockObject $builderInterface2 */
        $builderInterface2 = $this->getMockForAbstractClass('Packback\ElasticsearchDSL\BuilderInterface');
